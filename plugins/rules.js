...
`.trim(), 'Kebijakan ©2022 By Rio', '⋮☰ Menu', '.menu', 'Owner', '.nowner', 'Donasi', '.donasi', m, {
    quoted: m,
    contextInfo: {
        externalAdReply: {
            title: 'Harap patuhi peraturan tersebut ya!',
            body: `${pickRandom(['udah makan belum kak?', 'udah mandi belum kak?', 'Semangat ya kak!', 'Jangan begadang mulu ya!', 'jangan spam ya kak!', 'Jangan lupa donasi yak kak! >.<', 'Jaga kesehatan ya kak!', 'Jangan lupa makan!', 'Jangan lupa istirahat yak! >.<', 'I Love you kak >.< 💗✨', 'Pr nya udh belum kak?', 'Jangan kebanyakan main hp yk! nanti sakit :‹'])}`,
         ...
         mediaUrl: `https://www.instagram.com/riyoshi_dyxn`
        }
     }
    })
handler.help = ['rules']
