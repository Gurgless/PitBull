...
module.exports = {
    async handler(chatUpdate) {
        ...
        global.author = 'Made By Rio © 2022'
        global.packname2 = 'Made With'
        global.author2 = 'R-BOT By Rio © 2022'
        global.wm3 = 'Made By Rio˚'
        global.wm2 = '© R-BOT' + ' ' + 'By Rio'
        global.wm = '© R-BOT'
        global.colong1 = 'R-BOT'
        global.colong2 = 'By Rio'
        global.kontak2 = [
        ['6285664770042', 'Rio Fernanda', 'Creator Bot', 'rbot-cs@outlook.co.id', true],
        ['6282377306954', 'R-BOT MD', 'Bot WhatsApp', 'Just Bot', true]
        ]
...
global.waifu = ['https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcROSde25FApzVZiOPPyxl730xOQkUbt9atYfA&usqp=CAU',
'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQoveOIzsb7e-JwR-az1eIUlBLFaL0EQ13aqPiACXCxCDpt8lorTXq2z_I&s=10']
